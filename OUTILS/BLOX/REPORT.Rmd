...
knitr::opts_chunk$set(dpi=69, out.width="100%", message=FALSE, warning=FALSE, echo=FALSE, dev=c("png"))
...
for (country in country.list[country.list !="EU"]) {
  out=c(out, knitr::knit_expand(here("OUTILS","BLOX","REPORT [COUNTRY].Rmd")))
}
